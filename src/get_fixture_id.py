...
if __name__ == "__main__":
    # print(get_id(team="Tottenham", league=39, date="2026-05-11", season=2025))
    # print(get_id(team="Man", league=39, date="2026-05-13", season=2025))
    ...
    # add_fixture(get_id(team="Bayern", league=78, date="2026-05-16", season=2025))
    # # add_fixture(1540842)
    # # add_fixture(1540843)
    # add_fixture(get_id(team="arsenal", league=39, date="2026-05-18", season=2025))
    # add_fixture(get_id(team="chelsea", league=39, date="2026-05-19", season=2025))
    # add_fixture(get_id(team="bayern", league=81, date="2026-05-23", season=2025))
    # add_fixture(get_id(team="arsenal", league=39, date="2026-05-24", season=2025))
    # add_fixture(get_id(team="tottenham", league=39, date="2026-05-24", season=2025))
    # add_fixture(get_id(team="aston", league=39, date="2026-05-24", season=2025))
    # add_fixture(get_id(team="leeds", league=39, date="2026-05-24", season=2025))
    # add_fixture(get_id(team="arsenal", league=2, date="2026-05-30", season=2025))
    # print(get_fixture(979139)["response"][0]["result"])
    print(get_id(league=10, season=2026))